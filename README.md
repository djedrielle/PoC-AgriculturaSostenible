...
Se aplicó Factory Method en la creación de los tokens (tokens.ts). Esto para permitir la adición de otros tipos de tokens en el futuro. Ejemplo: Piña Token, BananoToken... etc.