class Transaction {
    ...
    constructor(transaction_id: string, transaction_hash: string, token_amount_transferred: number, token_unit_price: number, platform_comition: number, transaction_date: string) {
