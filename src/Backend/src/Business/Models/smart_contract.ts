export class SmartContract {
    ...
    constructor(contract_address: string, standard_implemented: string, initial_token_price: number, total_tokens: number, active: boolean, contract_state: string, emition_date?: string, contract_id?: string) {
